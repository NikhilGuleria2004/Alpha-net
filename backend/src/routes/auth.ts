...
import { login, me, refresh, logout, register, forgotPassword, resetPassword, requestOtp, verifyOtp, changePasswordHandler } from '../controllers/auth.controller.js'
...
export function authRoutes() {
  ...
  // Forgot-password OTP login: code emailed to the registered address, then
  // exchanged for a full session (access token + refresh cookie).
