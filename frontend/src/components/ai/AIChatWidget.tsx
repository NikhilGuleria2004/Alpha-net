  ...
  return (
    <>
      <button
        ...
        className={`fixed bottom-6 right-6 z-40 flex items-center gap-2 rounded-full bg-accent px-4 py-3 text-white shadow-xl transition-all hover:bg-accent-hover ${
      ...
      >
        ...
        {messages.length > 0 && (
          <span className="flex h-5 min-w-[20px] items-center justify-center rounded-full bg-white px-1 text-xs font-semibold text-accent-hover">
