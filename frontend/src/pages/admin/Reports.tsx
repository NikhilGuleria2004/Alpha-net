    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Timesheet analytics and insights.</p>
        </div>
        ...
        <div className="border-b border-border px-5 py-4">
          <div className="flex flex-col gap-4 lg:flex-row">
            <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-end">
              ...
              <Select value={statusFilter} onChange={(e) => setStatusFilter(e.target.value as ReportStatusFilter)} className="w-full sm:w-40" options={[
      ...
      {isLoading ? (
        ...
        <div className="space-y-6">
          <Card>
            <div className="border-b border-border px-5 py-4">
              <h2 className="text-lg font-semibold text-foreground">Hours by Project</h2>
            </div>
            <div className="p-5">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <Card>
              <div className="border-b border-border px-5 py-4">
                <h2 className="text-lg font-semibold text-foreground">Hours by Employee</h2>
              </div>
              <div className="p-5">
            ...
            <Card>
              <div className="border-b border-border px-5 py-4">
                <h2 className="text-lg font-semibold text-foreground">Timesheet Status</h2>
              </div>
              <div className="p-5">
          ...
          {overtimeStats && (
            <Card>
              <div className="border-b border-border px-5 py-4">
                <h2 className="text-lg font-semibold text-foreground">Overtime Summary</h2>
              </div>
              <div className="p-5">
